...
| [account-lifecycle.md](account-lifecycle.md) | How accounts come to exist (admin-created, self-provisioned) and how they end (retirement, email tombstoning, membership lookups)         |
| [access-control.md](access-control.md)       | RBAC, the super-admin tier, lockout invariants, required-permission rules, the admin surface, the audit trail                             |
...
| `SECURITY_*`, `TRUSTED_*`, `CAPTCHA_*`, `APP_SUPPORTED_LOCALES`, `CORS_ALLOWED_ORIGINS`   | [hardening.md](hardening.md)                                                                                 |
