...
return [
    ...
    */
    ...
    'password' => [
        'common' => ':Attribute apare într-o listă de parole frecvent utilizate. Vă rugăm să alegeți o altă parolă.',
        ...
        'personal' => ':Attribute nu trebuie să conțină numele, adresa de e-mail sau numele aplicației.',
    ...
    */
    ...
    'attributes' => [
        ...
        'value' => 'valoarea setării',
        'value.enabled' => 'starea de activare',
        'value.level' => 'severitatea',
        'value.message' => 'mesajul',
        'value.message.*' => 'mesajul',
        'value.inactive_days' => 'perioada de inactivitate (zile)',
        'value.notice_days' => 'perioada de preaviz (zile)',

        // Admin list filters: dotted paths would otherwise render verbatim in the message.
        'filter.search' => 'filtrul de căutare',
        'filter.status' => 'filtrul de stare',
        'filter.role_id' => 'filtrul de rol',
        'filter.two_factor' => 'filtrul de autentificare în doi pași',
        'filter.onboarding' => 'filtrul de onboarding',
        ...
        'type' => 'tipul',
        'mode' => 'modul',
        'remember' => 'opțiunea ține-mă minte',
        'redirect' => 'adresa de redirecționare',
        'delivery' => 'metoda de livrare',
        'abilities' => 'permisiunile tokenului',
        'abilities.*' => 'permisiunea tokenului',
        'per_page' => 'numărul pe pagină',
        'ban_reason' => 'motivul blocării',
        'banned' => 'starea de blocare',
        'email_verified' => 'starea de verificare a emailului',
        'expires_in_days' => 'expirarea (zile)',
        'is_active' => 'starea contului',
        'permission_ids' => 'permisiunile',
        'permission_ids.*' => 'permisiunea',
        'role_ids' => 'rolurile',
        'role_ids.*' => 'rolul',
        'require_password_reset' => 'resetarea obligatorie a parolei',
        'revoke_other_sessions' => 'deconectarea celorlalte sesiuni',
        'two_factor_required' => 'obligativitatea autentificării în doi pași',
        'locale' => 'limba',
        'theme' => 'tema',
    ],
];
