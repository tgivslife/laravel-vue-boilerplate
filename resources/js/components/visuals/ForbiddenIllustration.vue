...
<template>
    ...
    >
        <g id="Group_9" data-name="Group 9" transform="translate(-589 -184)">
            <path id="Path_274-3300" data-name="Path 274"
            ...
            <path id="Path_968-3301" data-name="Path 968"
                  ...
                  transform="translate(360.209 90.287)" fill="currentColor"/>
            <path id="Path_969-3302" data-name="Path 969"
                  ...
                  transform="translate(360.209 90.287)" fill="var(--ui-bg)"/>
            <circle id="Ellipse_18" data-name="Ellipse 18" cx="96.565" cy="96.565" r="96.565"
                    transform="translate(938 287.564)" fill="var(--ui-primary)"/>
            <path id="Path_39-3303" data-name="Path 39"
                  ...
                  transform="translate(360.209 90.287)" fill="var(--ui-bg-accented, #e6e6e6)"/>
            <path id="Path_40-3304" data-name="Path 40"
                  d="M637.7,454.074a2.665,2.665,0,0,0,0,5.329H763.3a2.665,2.665,0,0,0,.2-5.326l-.117,0H637.7Z"
                  transform="translate(360.209 90.287)" fill="var(--ui-bg-accented, #e6e6e6)"/>
            <path id="Path_41-3305" data-name="Path 41"
                  d="M637.7,470.058a2.664,2.664,0,1,0,0,5.329H763.3a2.665,2.665,0,0,0,.2-5.326l-.117,0H637.7Z"
                  transform="translate(360.209 90.287)" fill="var(--ui-bg-accented, #e6e6e6)"/>
            <path id="Path_42-3306" data-name="Path 42"
            ...
            <g id="Group_58" data-name="Group 58" transform="translate(589 184)">
                <path id="Path_438-3313" data-name="Path 438"
                      ...
                      transform="translate(-228.791 -93.713)" fill="var(--ui-bg-accented, #e6e6e6)"/>
                <path id="Path_439-3314" data-name="Path 439"
                      ...
                      transform="translate(-228.791 -93.713)" fill="var(--ui-bg-elevated, #f2f2f2)"/>
                <path id="Path_442-3315" data-name="Path 442"
                      ...
                      transform="translate(-228.791 -93.713)" fill="var(--ui-bg-accented, #e6e6e6)"/>
                <path id="Path_443-3316" data-name="Path 443"
            ...
            <g id="Group_59" data-name="Group 59" transform="translate(589 184)">
                <circle id="Ellipse_5" data-name="Ellipse 5" cx="15.986" cy="15.986" r="15.986"
                        transform="translate(355 354.999)" fill="var(--ui-primary)"/>
                <path id="Path_40-3-3317" data-name="Path 40-3"
            ...
            <g id="Group_60" data-name="Group 60" transform="translate(589 184)">
                <circle id="Ellipse_5-2" data-name="Ellipse 5-2" cx="15.986" cy="15.986" r="15.986"
                        transform="translate(355 440.292)" fill="var(--ui-primary)"/>
                <path id="Path_40-4-3318" data-name="Path 40-4"
            ...
            <g id="Group_61" data-name="Group 61" transform="translate(589 184)">
                <circle id="Ellipse_5-3" data-name="Ellipse 5-3" cx="15.986" cy="15.986" r="15.986"
                        transform="translate(355 525.55)" fill="var(--ui-primary)"/>
                <path id="Path_40-5-3319" data-name="Path 40-5"
            ...
            <rect id="Rectangle_117" data-name="Rectangle 117" width="8" height="67"
                  transform="translate(1008.051 363.268) rotate(-45)" fill="var(--ui-bg)"/>
            <rect id="Rectangle_118" data-name="Rectangle 118" width="8" height="67"
                  transform="translate(1055.426 357.616) rotate(45)" fill="var(--ui-bg)"/>
            <path id="Path_254-3320" data-name="Path 254"
            ...
            <path id="Path_255-3321" data-name="Path 255" d="M118.679,694.215H102.244L94.425,630.82h24.257Z"
                  transform="translate(589 184)" fill="#9f616a"/>
            <path id="Path_257-3322" data-name="Path 257" d="M204.713,680.461l-15.7,4.873L162.751,627.11l23.166-7.192Z"
                  transform="translate(589 184)" fill="#9f616a"/>
            <path id="Path_973-3323" data-name="Path 973" d="M334.884,495.656l-24.341,27.877,19.056,1.715Z"
                  transform="translate(360.209 90.287)" fill="var(--ui-bg-accented, #e6e6e6)"/>
            <path id="Path_975-3324" data-name="Path 975"
            ...
            <path id="Path_976-3325" data-name="Path 976"
                  ...
                  transform="translate(360.209 90.287)" fill="var(--ui-bg-accented, #e5e5e5)"/>
            <path id="Path_980-3326" data-name="Path 980"
            ...
            <path id="Path_982-3327" data-name="Path 982" d="M407.279,472.932v-7.4L371.35,524.718Z"
                  transform="translate(360.209 90.287)" opacity="0.1" style="isolation: isolate"/>
            <path id="Path_983-3328" data-name="Path 983"
                  ...
                  transform="translate(360.209 92.401)" fill="currentColor"/>
            <path id="Path_259-3329" data-name="Path 259"
                  d="M355.354,552.839a10.056,10.056,0,0,0,2.738-15.174l18.423-30.62-18.554.768-14.65,28.96a10.11,10.11,0,0,0,12.043,16.067Z"
                  transform="translate(360.209 90.287)" fill="#9f616a"/>
            <path id="Path_981-3330" data-name="Path 981"
                  ...
                  transform="translate(360.209 90.287)" fill="var(--ui-bg-accented, #e5e5e5)"/>
            <path id="Path_277-3331" data-name="Path 277"
                  ...
                  transform="translate(267.08 81.168)" fill="currentColor"/>
            <path id="Path_278-3332" data-name="Path 278"
                  ...
                  transform="translate(280.5 81.521)" fill="currentColor"/>
        </g>
    </svg>
</template>
