{{--
    Override of laravel/horizon's layout view (vendor/laravel/horizon/resources/views/layout.blade.php),
    identical except the fonts.bunny.net preconnect + Figtree stylesheet are removed: the app makes no
    third-party requests (and the CSP would block them), so the dashboard falls back to the system font
    stack in Horizon's own CSS. Re-sync this copy when upgrading Horizon if the vendor layout changes.
--}}
<!DOCTYPE html>
<html lang="en">
<head>
